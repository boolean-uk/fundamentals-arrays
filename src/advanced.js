...
let withSevenThreeEight = []
withSevenThreeEight = arrayToExtend.filter(x => x === 7 || x === 3 || x === 8 )

// 7. add the numbers from otherNums to the end of numsToMerge
let combinedNums = []
combinedNums = numsToMerge.concat(otherNums)
...
let moreCities = []
moreCities = ["Sydney", ...newCities, "Berlin"]
