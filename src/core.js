...
teachers.push('Vanessa') // add elm to end of array
// console.log(teachers)

// 6. Remove 'Ed' from the teachers array
teachers.shift() // removes first elm of array
// console.log(teachers)

// 7. Add a teacher named 'Sarah' to the beginning of the teachers array
teachers.unshift('Sarah') // add elm to start of array
// console.log(teachers)
